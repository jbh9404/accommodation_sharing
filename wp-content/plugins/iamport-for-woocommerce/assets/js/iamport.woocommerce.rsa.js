...
jQuery(function($) {
	...
	function check_required_card_field(gateway, param) {
		if ( gateway == 'iamport_subscription' ) {
			return 	param['iamport_subscription-card-number'] &&
				 	param['iamport_subscription-card-expiry'] &&
				 	param['iamport_subscription-card-birth'] &&
				 	param['iamport_subscription-card-pwd'];
