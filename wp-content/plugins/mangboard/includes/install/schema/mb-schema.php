...
) DEFAULT CHARACTER SET='utf8' COLLATE='utf8_general_ci' COMMENT='board table';";
...
$mb_schema["comment"]= "(
  ...
  KEY `user_pid` (`user_pid`),
  KEY `parent_user_pid` (`parent_user_pid`)
) DEFAULT CHARACTER SET='utf8' COLLATE='utf8_general_ci' COMMENT='comment table';";
...
$mb_schema["h_editors"]		= "(
  ...
  PRIMARY KEY (`pid`),
  KEY `reg_date` (`reg_date`)
) DEFAULT CHARACTER SET='utf8' COLLATE='utf8_general_ci' COMMENT='h-editor table';";
