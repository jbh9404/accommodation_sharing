...
//	iMinUndoInterval : 50,
	...
	$init : function(iframe){
		...
		this.sBlankPageURL = "./?mb_ext=seditor&se_skin=smart_editor2_inputarea";
		this.sBlankPageURL_EmulateIE7 = "./?mb_ext=seditor&se_skin=smart_editor2_inputarea_ie8";
	...
	initIframe : function(){
		try {
			...
			if (sCSSBaseURI){
				...
				sCssUrl = mb_editor_url+"css/"+sLocale+"/smart_editor2_in.css";
...
nhn.husky.SE_EditingAreaVerticalResizer = jindo.$Class({
	...
	$ON_MSG_APP_READY : function(){
		...
		if(typeof(this.htConversionMode) !== 'undefined' && typeof(this.htConversionMode.bUsePhotoUpload) !== 'undefined' && this.htConversionMode.bUsePhotoUpload === false){				//mb edit
			this.oPhotoUpload = cssquery.getSingle(".se2_multy", document);
			this.oPhotoUpload.style.display = 'none';
		}		
		...
		if(this.oApp.bMobile){
			...
			this.oResizeGrip.style.overflow= 'hidden';		//mb edit
		}else{
...
nhn.husky.SE2B_CSSLoader = jindo.$Class({
	...
	*/
	...
	loadSE2CSS : function(sMsg, oArgs){
		...
		var sLocale = this.oApp && this.oApp.htOptions.I18N_LOCALE;
		sCssUrl = mb_editor_url+"css/"+sLocale+"/smart_editor2_items.css";		
