...
<link href="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/css/en_US/smart_editor2.css" rel="stylesheet" type="text/css">
<style type="text/css">
	body { margin: 10px; }
</style>
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/js/lib/jindo2.all.js?ver=1.4.8" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/js/lib/jindo_component.js?ver=1.4.8" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/js/service/SE2M_Configuration.js?ver=1.4.8" charset="utf-8"></script>	<!-- 설정 파일 -->
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/js/service/SE2BasicCreator.js?ver=1.4.8" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/js/smarteditor2.min.js?ver=1.4.8" charset="utf-8"></script>
<!-- 사진첨부기능 edit --> 
<script type="text/javascript" src="<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/sample/js/plugin/hp_SE2M_AttachQuickPhoto.js?ver=1.4.8" charset="utf-8"></script>
<script type="text/javascript">var mb_editor_url = "<?php echo MBW_PLUGIN_URL;?>plugins/editors/smart/"; </script>
</head>
<body>
...
<div id="smart_editor2">
	<div id="smart_editor2_content"><a href="#se2_iframe" class="blind">글쓰기영역으로 바로가기</a>
		<div class="se2_tool" id="se2_tool">
			...
			<!-- 사진첨부기능 edit --> 
			<ul class="se2_multy">
					<li class="se2_mn husky_seditor_ui_photo_attach"><button type="button" class="se2_photo ico_btn"><span class="se2_icon"></span><span class="se2_mntxt">Image<span class="se2_new"></span></span></button></li>
			</ul>
			</div>
			<!-- //704이상 -->
		</div>
