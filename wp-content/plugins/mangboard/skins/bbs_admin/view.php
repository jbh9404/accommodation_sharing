...
function showDeleteConfirm(data){
	showConfirmPopup("<?php echo __MM('MSG_DELETE_CONFIRM');if(!mbw_is_login()) echo '<br>'.__MM('MSG_PASSWD_INPUT');?>", data, sendBoardDeleteData);	
}
		...
		<div class="btn-box-right" id="<?php echo $mb_board_name;?>_btn_box">
			<?php
				...
				if(mbw_is_user_pid("guest"))
					echo mbw_get_btn_template(array("name"=>"Delete","onclick"=>"showDeleteConfirm({'type':'passwd'})","class"=>"btn btn-default btn-delete"));
