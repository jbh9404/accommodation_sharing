...
jQuery(document).ready(function ($) {
    ...
    function wpestate_allinone_owner_insert_customprice_internal() {
        var period_extra_price_per_guest, period_price_per_weekeend, period_checkin_change_over,
            period_checkin_checkout_change_over, period_min_days_booking, start_from, end_to, listing_edit, new_price,
            ajaxurl;
    ...
    $('#form_submit_1').click(function () {
        ...
        var security, ajaxurl, title, prop_category, prop_action_category, property_city, property_area_front,
            property_country, property_description, guest_no, new_estate, instant_booking;

        title = jQuery('#title').val();
        prop_category = jQuery('#prop_category_submit').val();
        prop_action_category = "74";
    ...
    var curent_m, curent_m_set, input, defaultBounds, options, componentForm, autocomplete, place, calendar_click,
        calendar_click_price;
    curent_m = 2;
    curent_m_set = 1;
    ...
    function mark_as_price_actions() {
        "use strict";
        var period_price_per_month, period_price_per_week, period_extra_price_per_guest, period_price_per_weekeend,
            period_checkin_change_over, period_checkin_checkout_change_over, period_min_days_booking, start_from,
            end_to, listing_edit, new_price, ajaxurl;
    ...
    ////////////////////////////////////////////////////////////////////////////
    $(function () {
        $.getScript("http://nagne.kr/wp-content/themes/wprentals/js/search.min.js"),
            $.Deferred(function (deferred) {
                $(deferred.resolve);
            }).done(function () {
                $("#find_loc").click(function () {
                    $("#find_loc").postcodifyPopUp();
                });
            });
    });
    ...
    $('#edit_prop_locations').click(function () {
        var jsonData, ajaxurl, listing_edit, property_address,
    ...
    $('#edit_prop_details').click(function () {
        var i, jsonData, ajaxurl, property_size, property_rooms, property_bedrooms, property_bathrooms, listing_edit,
            custom_fields_val, variable, counter;
    ...
    function save__details() {
        var i, jsonData, ajaxurl, property_size, property_rooms, property_bedrooms, property_bathrooms,
            custom_fields_val, variable, counter, listing_edit;
        property_size = '';
        property_rooms = '';
        property_bedrooms = '';
        property_bathrooms = '';
    ...
    $('#edit_prop_image').click(function () {
        if (jQuery('#attachid').val() == "") {
            alert('1개 이상의 이미지를 업로드해주세요.');
        } else {
...
////////////////////////////////////////////////////////////////////////////
    $('#edit_prop_1').click(function () {
        ...
        var ajaxurl, title, category, action_category, guests, city, country, area, listing_edit, prop_desc,
            property_admin_area, instant_booking;
        title = jQuery('#title').val();
