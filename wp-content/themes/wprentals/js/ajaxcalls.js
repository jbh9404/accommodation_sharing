...
function start_filtering_ajax_map(newpage) {
    ...
    var guest_no, call_function, search_location_filter_autointernal, stype, property_admin_area, action, category,
        city, area, country, rooms, baths, beds, min_price, price_max, ajaxurl, postid, guest_no, check_out, check_in,
        all_checkers;
...
function start_filtering_ajax_on_main_map(guest_no) {
    ...
    var property_admin_area, action, category, country, city, area, rooms, baths, beds, min_price, price_max, ajaxurl,
        postid, guest_no, check_out, check_in, all_checkers;
...
function wpestate_register() {
    "use strict";
    var user_pass, user_pass_retype, capthca, user_login_register, user_email_register, nonce, ajaxurl, propid,
        user_type;
...
function wpestate_register_sh() {
    "use strict";
    var capthca, user_pass, user_pass_retype, user_login_register, user_email_register, nonce, ajaxurl, propid,
        user_type;
...
jQuery(document).ready(function ($) {
    ...
    $(function () {
        ...
        link.type = 'text/css';
        link.rel = 'stylesheet';
        link.href = "http://nagne.kr/wp-content/themes/wprentals/addon/datepicker/datepicker3.css";
        head.appendChild(link);

        $.getScript("http://nagne.kr/wp-content/themes/wprentals/addon/datepicker/bootstrap-datepicker.js"),
            $.getScript("http://nagne.kr/wp-content/themes/wprentals/addon/datepicker/bootstrap-datepicker.kr.js"),
    ...
    $('#update_profile').click(function () {
        var payment_info, paypal_payments_to, live_in, i_speak, usermobile, userpinterest, userlinkedin, usertwitter,
            userfacebook, profile_image_url, profile_image_url_small, firstname, secondname, useremail, userphone,
            userskype, usertitle, userbirthday, usergender, description, ajaxurl, securityprofile, upload_picture;
