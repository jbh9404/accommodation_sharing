...
function wpestate_featured_place($attributes, $content = null) {
    ...
    if( isset($attributes['extra_class_name'])){
        ...
        $term_link =  "http://nagne.kr/tour-list-map/";
...
function wpestate_register_form_function($attributes, $content = null) {
    ...
    $return_string.=' 
        ...
        <label id="user_terms_register_sh_label" for="user_terms_register_sh">'.esc_html__( 'I agree with ','wpestate').'(<a href="'.wpestate_get_terms_links().'" target="_blank" id="user_terms_register_topbar_link">'.esc_html__( '이용약관 확인').'</a>) </label>';
