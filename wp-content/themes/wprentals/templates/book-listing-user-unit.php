        ...
        <div class="info-container_booking">
            ...
            if ($booking_status=='confirmed'){
                if($booking_status_full=='confirmed'){
                    print '<span class="tag-published">'.esc_html__( '결제완료').'</span>';
                }else{
                    print '<span class="tag-published">'.esc_html__( '승인완료').'</span>';
                    print '<span class="proceed-payment_full" data-invoiceid="'.$invoice_no.'" data-bookid="'.$post->ID.'">'.esc_html__( '쿠폰으로 결제').'</span>';
