                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea  rows="10" id="property_description" name="property_description"  class="advanced_select  form-control" placeholder="<?php esc_html_e('Describe your property','wpestate');?>"><?php echo $property_description; ?></textarea>
                        </div>
                    </div>
